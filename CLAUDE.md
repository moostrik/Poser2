...
passing run reads as a failure.
    ...
    python -m unittest modules.oak.tests.test_equirect_mesh modules.oak.tests.test_keystone_warp modules.pose.tests.test_distance_extractor modules.pose.tests.test_motion_time_extractor modules.settings.tests.test_reactive modules.tracker.tests.test_panoramic_tracker
