...
python modules\inference\tools\export_rtm_onnx_to_trt.py --onnx models\rtmpose-l_256x192.onnx --output models\rtmpose-l_256x192_b3.trt
...
:build_rvm_256x192
python modules\inference\tools\export_rvm_onnx_to_trt.py --onnx models\rvm_mobilenetv3_256x192.onnx --output models\rvm_mobilenetv3_256x192_b3.trt
...
:build_rvm_384x288
python modules\inference\tools\export_rvm_onnx_to_trt.py --onnx models\rvm_mobilenetv3_384x288.onnx --output models\rvm_mobilenetv3_384x288_b3.trt
...
:build_rvm_512x384
python modules\inference\tools\export_rvm_onnx_to_trt.py --onnx models\rvm_mobilenetv3_512x384.onnx --output models\rvm_mobilenetv3_512x384_b3.trt
...
:build_rvm_1024x768
python modules\inference\tools\export_rvm_onnx_to_trt.py --onnx models\rvm_mobilenetv3_1024x768.onnx --output models\rvm_mobilenetv3_1024x768_b3.trt
...
:build_raft_256x192
python modules\inference\tools\export_raft_onnx_to_trt.py --onnx models\raft-sintel_256x192_i12.onnx --output models\raft-sintel_256x192_i12_b3.trt
...
:build_raft_384x288
python modules\inference\tools\export_raft_onnx_to_trt.py --onnx models\raft-sintel_384x288_i12.onnx --output models\raft-sintel_384x288_i12_b3.trt
...
:build_raft_512x384
python modules\inference\tools\export_raft_onnx_to_trt.py --onnx models\raft-sintel_512x384_i12.onnx --output models\raft-sintel_512x384_i12_b3.trt
