...
discrete lamps (front/back white, left/right blue) directly and reads no projection pixels. The
...
spinning-down bar in beam mode shows its lamps smeared into a wall, not the projection image.
...
or above the threshold the fixture steps the projection pixels and the projection layers take
