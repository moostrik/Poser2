"""SoundLight — the soundscape made visible: the left and right blue lamps follow the
...
class SoundLightSettings(LayerSettings):
    ...
    def _draw(self, frame: Frame, white: np.ndarray, blue: np.ndarray) -> None:
        ...
        if levels.timestamp == 0.0 or monotonic() - levels.timestamp > P.stale_seconds:
            ...
            if P.fallback == SoundFallback.PULSE:
                ...
                self._add_lamps(white, blue, left_blue=pulse, right_blue=pulse)
            return
        ...
        self._add_lamps(white, blue, left_blue=left * P.gain, right_blue=right * P.gain)
