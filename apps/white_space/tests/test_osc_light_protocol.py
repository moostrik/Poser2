...
class FixtureSlotTest(unittest.TestCase):
    ...
    def test_projection_mode_sends_the_projection_image_and_drops_the_beam_lights(self) -> None:
        frame = self._lit_frame()
...
class ProjectionOffsetTest(unittest.TestCase):
    """The projection offset is the fixture's projection-image alignment, so it is applied here — on the
    ...
    def test_projection_mode_rotates_the_projection_image(self) -> None:
