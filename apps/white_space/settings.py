...
class OakGroup(BaseSettings):
    ...
    color             : Field[bool]            = Field(False, access=Field.INIT, description="Enable color capture")
    mono              : Field[bool]            = Field(True, access=Field.INIT, description="Enable mono capture")
...
class PoseGroup(BaseSettings):
    ...
    frequency        : Field[float]     = Field(30.0, access=Field.INIT)
    output_frequency : Field[float]     = Field(30.0)
    use_segmentation : Field[bool]      = Field(False, description="Enable mask/segmentation extraction")
