...
class SimulatorSettings(BaseSettings):
    ...
    playback_time:      Field[str]              = Field("0:00.0", access=Field.READ, description="Playback head", newline=True)
    start_time:         Field[str]              = Field("0:00.0", access=Field.READ, description="Start time")
