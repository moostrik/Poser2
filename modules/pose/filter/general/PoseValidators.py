...
class PoseValidatorBase(PoseFilterBase):
    ...
    @property
    def config(self) -> PoseValidatorConfig:
...
class PoseNanValidator(PoseValidatorBase):
...
class PoseRangeValidator(PoseValidatorBase):
...
class PoseScoreValidator(PoseValidatorBase):
...
class PoseValidator(PoseFilterBase):
    ...
    def __init__(self, config: PoseValidatorConfig | None = None) -> None:
        ...
        self._nan_validator = PoseNanValidator(self._config)
        self._range_validator = PoseRangeValidator(self._config)
        self._score_validator = PoseScoreValidator(self._config)
