...
class PoseConfidenceFilterBase(PoseFilterBase):
    ...
    @property
    def config(self) -> PoseConfidenceFilterConfig:
...
class PoseAngleConfidenceFilter(PoseConfidenceFilterBase):
...
class PosePointConfidenceFilter(PoseConfidenceFilterBase):
...
class PoseDeltaConfidenceFilter(PoseConfidenceFilterBase):
...
class PoseConfidenceFilter(PoseFilterBase):
    ...
    def __init__(self, config: PoseConfidenceFilterConfig) -> None:
        ...
        self._angle_filter = PoseAngleConfidenceFilter(config)
        self._point_filter = PosePointConfidenceFilter(config)
        self._delta_filter = PoseDeltaConfidenceFilter(config)
