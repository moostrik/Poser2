...
from modules.pose.filters.general.PoseSmoothers import PoseSmootherConfig



class PoseSmootherGui:
    def __init__(self, config: PoseSmootherConfig, gui: Gui, name: str) -> None:
        self.gui: Gui = gui
        self.config: PoseSmootherConfig = config
