...
class MaskBatchExtractor(TypedCallbackMixin[dict[int, torch.Tensor]]):
    ...
    def __init__(self, settings: Settings):
        ...
        self._process_timer =   PerformanceTimer(name="RVM Segmentation", sample_count=100, report_interval=100, color='cyan', omit_init=2)
        self._wait_timer =      PerformanceTimer(name="RVM Wait        ", sample_count=100, report_interval=100, color='cyan', omit_init=2)
