...
class BBoxChaseInterpolatorTracker(InterpolatorTracker):
    ...
    def __init__(self, num_tracks: int, config: ChaseInterpolatorSettings) -> None:
        super().__init__(
...
class BBoxLerpInterpolatorTracker(InterpolatorTracker):
    ...
    def __init__(self, num_tracks: int, config: LerpInterpolatorSettings) -> None:
        super().__init__(
            num_tracks=num_tracks,
