...
from .io import DetectionInput, DetectionOutput, PoseDetectionOutputCallback
...
class RunnerTRT(Thread):
    ...
    def _infer(self, gpu_imgs: list[torch.Tensor]) -> tuple[np.ndarray, np.ndarray, float, float]:
        ...
        keypoints, scores = RunnerTRT._decode_simcc_cpu(simcc_x_cpu, simcc_y_cpu, self.simcc_split_ratio)
