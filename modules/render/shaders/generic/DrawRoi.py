...
class DrawRoi(Shader):
    def use(self, tex0: Texture, roi: Rect, rotation_radians: float = 0.0, rotation_center_texture_space: Point2f = Point2f(0.5, 0.5), texture_aspect: float = 1.0, flip_x: bool = False, flip_y: bool = True) -> None:
