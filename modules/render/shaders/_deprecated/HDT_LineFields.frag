...
uniform sampler2D cam_tex_0;
uniform sampler2D cam_tex_1;
uniform sampler2D cam_tex_2;
uniform sampler2D line_tex_l;
uniform sampler2D line_tex_r;
uniform vec4 cam_color_0;
uniform vec4 cam_color_1;
uniform vec4 cam_color_2;
uniform float visibility_0;
uniform float visibility_1;
uniform float visibility_2;
