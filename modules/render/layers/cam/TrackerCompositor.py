...
class TrackerCompSettings(BaseSettings):
    ...
    pose_line_width:Setting[float] = Setting(2.0, min=0.5, max=10.0, description="Pose line width")
    bbox_line_width:Setting[int]   = Setting(2, min=1, max=10, description="Bounding box line width in pixels")
