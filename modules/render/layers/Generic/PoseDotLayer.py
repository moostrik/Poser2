...
class PoseDotLayer(LayerBase):
    ...
    def deallocate(self) -> None:
        ...
        if PoseDotLayer._shader.allocated:
            PoseDotLayer._shader.deallocate()
    ...
    def update(self) -> None:
        ...
        PoseDotLayer._shader.use(self._fbo.fbo_id, pose.points, dot_size=dot_size, dot_smooth=dot_smooth)