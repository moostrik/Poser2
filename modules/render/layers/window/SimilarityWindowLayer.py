...
class SimilarityWindowLayer(LayerBase):
    """Visualizes similarity window for a single track.

    Displays similarity values as horizontal lines (one per similarity element),
    with time flowing left-to-right. Sources data from SimilarityWindowTracker
    ...
    def __init__(self, track_id: int, data_hub: DataHub, line_width: float) -> None:
        ...
        self._data_type: DataHubType = DataHubType.similarity_window
