...
from modules.render.shaders.window import PoseAngleWindow, WindowShaderBase
from ..data.Colors import POSE_COLOR_LEFT, POSE_COLOR_RIGHT
from .WindowLayerBase import WindowLayerBase


class AngleWindowLayer(WindowLayerBase):
