...
# from modules.data.depricated.RenderDataHub import RenderDataHub
...
class HDTRenderManager(RenderBase):
    def __init__(self, gui: Gui, data_hub: DataHub, settings: Settings) -> None:
        ...
        # meshes
        self.pose_meshes =              PoseMesh(self.data_hub, self.num_players)
        ...
        for i in range(self.num_cams):
            self.camera_layers[i] = CamTrackPoseLayer(self.data_hub, self.pose_meshes, i)
