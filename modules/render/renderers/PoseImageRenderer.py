...
class PoseImageRenderer(RendererBase):
    def __init__(self, track_id: int, data: DataHub) -> None:
    ...
    def update(self) -> None:
        frame: np.ndarray | None = self._data.get_item(DataType.cam_image, self._track_id)
