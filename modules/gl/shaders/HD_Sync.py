...
class HD_Sync(Shader):
    ...
    def use(self, fbo, tex0, tex1, tex2, noise, blend1: float, blend2: float) -> None :
        super().use()
        if not self.allocated: return
        if not fbo or not tex0 or not tex1 or not tex2: return
        ...
        glUniform1i(glGetUniformLocation(s, "noise"), 3)
